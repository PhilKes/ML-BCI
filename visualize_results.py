...
from utils import matplot

parser = argparse.ArgumentParser(
    description='Visualizer Script for Benchmark results')
...
batch_lat_avgs, trial_inf_time_avgs = results['batch_lat_avgs'], results['trial_inf_time_avgs']
