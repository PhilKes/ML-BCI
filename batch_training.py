...
start = datetime.now()
folder = f"{datetime_to_folder_str(start)}_batch_training_34classes"
...
# global_config.USE_NOTCH_FILTER = True
global_config.FREQ_FILTER_HIGHPASS = 60
global_config.FREQ_FILTER_LOWPASS = 2
single_run(default_options + ['--name', f"{folder}/conf_no_es_bp_60_2", "--no_early_stop"])
single_run(default_options + ['--name', f"{folder}/conf_es_bp_60_2"])
# global_config.USE_NOTCH_FILTER = False
