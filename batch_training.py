...
global_config.FREQ_FILTER_HIGHPASS = None
global_config.FREQ_FILTER_LOWPASS = 60
single_run(default_options + ['--name', f"{folder}/conf_es_bp_None_60"])
single_run(default_options + ['--name', f"{folder}/conf_no_es_bp_None_60", "--no_early_stop"])

global_config.FREQ_FILTER_HIGHPASS = None
global_config.FREQ_FILTER_LOWPASS = 40
single_run(default_options + ['--name', f"{folder}/conf_es_bp_None_40"])
single_run(default_options + ['--name', f"{folder}/conf_no_es_bp_None_40", "--no_early_stop"])

global_config.FREQ_FILTER_HIGHPASS = None
global_config.FREQ_FILTER_LOWPASS = None
single_run(default_options + ['--name', f"{folder}/conf_no_es", "--no_early_stop"])
# global_config.USE_NOTCH_FILTER = False
